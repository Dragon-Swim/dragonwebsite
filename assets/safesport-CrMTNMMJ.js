import{i as s}from"./i18n-DxFiCXjI.js";import{a as e,r as a}from"./footer-DW7Wf5O4.js";s();e();const t=document.getElementById("app");t.innerHTML=`
  <section class="section" style="min-height: calc(100vh - var(--nav-height)); align-content: center;">
    <div class="container" style="max-width: 800px;">
      ...
      <div style="background: var(--bg-card); padding: var(--space-2xl); border-radius: var(--radius-lg); border: 1px solid var(--border-color); color: var(--text-secondary); line-height: 1.8;">
        <p style="margin-bottom: var(--space-lg);">Dragon Swim Team is committed to maintaining a safe, positive, and respectful environment for all athletes, coaches, and families. Below are essential SafeSport resources for reporting concerns, understanding policies, and upholding our shared responsibility to protect every participant.</p>

        <div class="safesport-links" style="display: flex; flex-direction: column; gap: var(--space-md);">
