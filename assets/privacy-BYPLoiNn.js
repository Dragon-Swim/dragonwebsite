import{i as e}from"./i18n-DIN1ScE8.js";import{a as r,r as t}from"./footer-BlCt1bcg.js";e();r();const a=document.getElementById("app");a.innerHTML=`
  <section class="section" style="min-height: calc(100vh - var(--nav-height)); align-content: center;">
    <div class="container" style="max-width: 800px;">
      ...
      <div style="background: var(--bg-card); padding: var(--space-2xl); border-radius: var(--radius-lg); border: 1px solid var(--border-color); color: var(--text-secondary); line-height: 1.8;">
        ...
        <p>If you have any questions about this Privacy Policy or wish to exercise your data rights, please email us at <a href="mailto:dragonswim@outlook.com" style="color: var(--color-primary);">dragonswim@outlook.com</a>.</p>
