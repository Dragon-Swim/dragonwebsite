import{t as s,u as i,a as l}from"./i18n-DIN1ScE8.js";function c(){const a=document.createElement("nav");a.className="navbar",a.id="navbar",a.innerHTML=`
    <div class="nav-container container">
      ...
      <div class="nav-links" id="nav-links">
        <a href="/" class="nav-link ${e("/")}">${s("nav_home")}</a>
        <a href="/dashboard.html" class="nav-link ${e("/dashboard.html")}">Dashboard</a>
        <a href="/signin.html?mode=signup" class="nav-link ${e("/registration.html")||e("/signin.html")}">${s("nav_registration")}</a>

        <a href="/signin.html" class="nav-link nav-link-signin ${e("/signin.html")}">${s("nav_signin")}</a>
      </div>
