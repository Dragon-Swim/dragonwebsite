import{i as I}from"./i18n-C8EWnRiK.js";import{a as N,r as D}from"./footer-DoA2MGdd.js";import{o as $,h as B,g,e as f,b as C,n as L,s as w,q as S,k as T,c as O,j as x}from"./firebase-B6pM3H1n.js";I();N();let v=null,d="create";const P=document.getElementById("app");$(C,async n=>{if(!n){window.location.href="/dragonwebsite/signin.html";return}const i=await B(g(f,"users",n.uid));if((i.exists()?i.data().role:null)!=="admin"){window.location.href="/dragonwebsite/dashboard.html";return}v=n,E()});function E(){P.innerHTML=`
