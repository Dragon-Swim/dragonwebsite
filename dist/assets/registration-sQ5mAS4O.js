import{i as A,t}from"./i18n-Cco8IODB.js";import{a as j,r as F}from"./footer-Dnfp5V27.js";import{o as P,h as T,g as E,e as w,q as V,w as x,c as z,i as M,u as R,b as H,m as O}from"./firebase-CorBctTj.js";A();j();let I=1,v=null;const W=document.getElementById("app");function a(e,i=!0){return i?`${e}<span class="req-star" aria-hidden="true">*</span>`:e}function C(e){return(e||"").toLowerCase().replace(/[.,'’`\-]/g," ").replace(/\s+/g," ").trim()}function q(e,i){return C(`${e||""} ${i||""}`)}function S(e){let i=(e||"").replace(/\D/g,"");return i.length===11&&i.startsWith("1")&&(i=i.slice(1)),i}function N(){return`
