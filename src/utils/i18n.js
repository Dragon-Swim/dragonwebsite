...
const translations = {
    en: {
        ...
        hero_subtitle: 'Top 50 Age Group Small Team in both 2025 and 2026! Best Small Team in PVS Swimming!\n\nUnder the leadership of Coach Kevin, Dragon Swim has earned ASCA Top 100 Age Group Team honors in 2020 and 2021 and Top 50 Age Group Small Team honors in both 2025 and 2026. Our program combines high-level coaching with individual attention, helping swimmers develop confidence, skills, and competitive success.',
        ...
        reg_conflict_error: 'Please fix the highlighted fields — some values are incorrect or match the account holder.',
        ...
        reg_err_address_email: 'This looks like an email address — please enter a street address.',
        reg_err_swimmer_is_holder: 'A swimmer cannot be the account holder. Please enter your child\'s name.',
        reg_err_swimmer_is_spouse: 'A swimmer cannot be the spouse on this account. Please enter your child\'s name.',
        ...
        dash_coach_needs_attention: 'Needs Attention',
        dash_coach_needs_attention_empty: 'All required registration info is complete.',
        dash_coach_unnamed: 'Unnamed',
        dash_coach_next_meet: 'Next',
        dash_attn_summary: 'Required missing {required} · Needs verification {conflicts} · Recommended {optional}',
        dash_attn_more_optional: '+{n} more with optional gaps only',
        dash_attn_required: 'Required missing',
        dash_attn_conflicts: 'Needs verification',
        dash_attn_optional: 'Recommended',
        dash_attn_scope_parent: 'Parent',
        dash_attn_scope_swimmer: 'Swimmer',
        dash_attn_scope_emergency: 'Emergency',
        dash_attn_scope_spouse: 'Spouse',
        dash_attn_scope_family: 'Family',
        dash_attn_scope_other: 'Info',
        dash_attn_parent_first: 'first name',
        dash_attn_parent_last: 'last name',
        dash_attn_parent_gender: 'gender',
        dash_attn_parent_phone: 'phone',
        dash_attn_parent_address: 'address',
        dash_attn_parent_missing: 'parent information missing',
        dash_attn_emergency_name: 'name',
        dash_attn_emergency_phone: 'phone',
        dash_attn_emergency_missing: 'emergency contact missing',
        dash_attn_swimmer_first: 'first name',
        dash_attn_swimmer_last: 'last name',
        dash_attn_usa_id: 'USA ID',
        dash_attn_dob: 'DOB',
        dash_attn_gender: 'gender',
        dash_attn_spouse_first: 'first name',
        dash_attn_spouse_last: 'last name',
        dash_attn_spouse_gender: 'gender',
        dash_attn_spouse_phone: 'phone',
        dash_attn_spouse_email: 'email',
        dash_attn_no_active_swimmers: 'No active swimmers',
        dash_attn_conflict_emergency_name_same: 'emergency contact is the parent',
        dash_attn_conflict_emergency_phone_same: 'emergency phone is the parent phone',
        dash_attn_conflict_spouse_name_same: 'spouse name matches the parent',
        dash_attn_conflict_spouse_email_same: 'spouse email matches the parent',
        dash_attn_conflict_parent_email_missing: 'parent email is missing',
        dash_attn_conflict_parent_emails_missing: 'parentEmails list is missing',
        dash_attn_conflict_parent_email_not_in_parent_emails: 'parent email {parentEmail} is not in parentEmails',
        dash_attn_conflict_parent_email_mismatch_auth: 'parent email {parentEmail} does not match sign-in email {authEmail}',
        dash_attn_conflict_unknown: 'data consistency issue',
        dash_attn_conflict_address_email: 'the address field contains an email address, not a street address',
        dash_attn_conflict_swimmer_is_holder: 'swimmer "{swimmerName}" is the account holder, not a child',
        dash_attn_conflict_swimmer_is_spouse: 'swimmer "{swimmerName}" is the spouse on this account',
        dash_attn_conflict_swimmer_is_adult: 'swimmer "{swimmerName}" is an adult (age {age})',
        dash_attn_needs_info: 'needs info',
        dash_rel_today: 'today',
        dash_rel_days: '{n}d ago',
        dash_coach_overview_meta: 'Season {season} · roster counts are all-time',
        dash_coach_meets_needing_fees: 'Meets Needing Fees',
        dash_coach_meets_needing_fees_empty: 'All meets have entry fees uploaded.',
        dash_coach_practices: 'Weekly Practices',
        dash_coach_practices_empty: 'No practices scheduled for this period.',
        ...
        sched2_slot_location: 'Location',
        sched2_slot_day: 'Day',
        sched2_slot_start: 'Start Time',
        sched2_slot_end: 'End Time',
        sched2_slot_group: 'Group Label (optional)',
        sched2_save: 'Add Session',
        sched2_cancel: 'Cancel',
        sched2_capacity: 'Capacity',
        sched2_capacity_hint: 'Leave empty until limits are decided.',
        sched2_manage_roster: 'Manage Roster',
        sched2_delete_slot: 'Delete',
        sched2_delete_confirm: 'Delete this session and all its sign-ups?',
        sched2_required_fields: 'Please fill in location, day, start time, and end time.',
        sched2_confirmed: 'Confirmed',
        sched2_undecided: 'Undecided',
        sched2_open: '{open} open',
        sched2_full: 'Full',
        sched2_no_capacity: 'capacity not set',
        sched2_manage_title: 'Sign-ups — {slot}',
        sched2_search_placeholder: 'Search swimmers…',
        sched2_no_swimmers: 'No swimmers found.',
        sched2_conflict_msg: 'Conflict: {name} is already confirmed in {slot} ({time}), which overlaps this session.',
        sched2_no_signups: 'No swimmers marked yet.',
        sched2_close: 'Close',
        sched2_family: 'Family',
        sched2_age: 'Age',
        sched2_remove: 'Remove',
        ...
        // ── Dashboard — Volunteer Hours Tab ──
        dash_coach_volunteer_label: 'Volunteer Hours',
        dash_coach_tab_volunteer: 'Volunteer Hours',
        dash_volunteer_intro: 'Hours are recorded per family, per meet — one number covers the whole family (both parents).',
        dash_volunteer_admin_only: 'Only admins can add or change volunteer hours.',
        dash_volunteer_stat_families: 'Families with hours',
        dash_volunteer_stat_total: 'Total hours',
        dash_volunteer_stat_zero: 'Families without hours',
        dash_volunteer_stat_meets: 'Meets covered',
        dash_volunteer_summary_title: 'Season Summary',
        dash_volunteer_th_family: 'Family (parents)',
        dash_volunteer_th_kids: 'Kids',
        dash_volunteer_th_kid_names: 'Kid names',
        dash_volunteer_th_meets: 'Meets',
        dash_volunteer_th_total_hours: 'Total hours',
        dash_volunteer_show_zero: 'Show families with 0 hours',
        dash_volunteer_entry_title: 'Record Hours for a Meet',
        dash_volunteer_meet_label: 'Meet',
        dash_volunteer_search_placeholder: 'Search family, kid or email…',
        dash_volunteer_only_entered: 'Only families with hours',
        dash_volunteer_th_hours: 'Hours',
        dash_volunteer_th_note: 'Note',
        dash_volunteer_th_updated: 'Updated',
        dash_volunteer_note_placeholder: 'e.g. timing, concessions',
        dash_volunteer_meet_total: 'Meet total',
        dash_volunteer_saving: 'Saving…',
        dash_volunteer_saved: 'Saved',
        dash_volunteer_save_failed: 'Save failed',
        dash_volunteer_invalid_hours: 'Hours must be a number of 0 or more.',
        dash_volunteer_export_summary: '📥 Summary CSV',
        dash_volunteer_export_detail: '📥 Detail CSV',
        dash_volunteer_no_meets: 'No meets in {season} yet. Volunteer hours are recorded per meet — add the meets first.',
        dash_volunteer_no_families: 'No registered families yet.',
        dash_volunteer_empty: 'No volunteer hours recorded for {season} yet.',
        dash_volunteer_no_match: 'No families match the current filter.',
        dash_volunteer_delete_confirm: 'Clear the recorded hours for this family at this meet?',
